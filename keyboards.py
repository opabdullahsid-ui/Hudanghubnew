...
def payment_method_menu():
    ...
    markup.add(
        types.InlineKeyboardButton("USDT (BEP20 / BSC)", callback_data="pay_bep20"),
        types.InlineKeyboardButton("USDT (TRC20)", callback_data="pay_trc20")
    )
    return markup
...
def products_menu(page=0):
    ...
    # --- CHANGED TO 10 PRODUCTS PER PAGE ---
    per_page = 10
